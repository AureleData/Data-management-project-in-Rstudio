...
# Install and load the 'rio' package if you haven't already
install.packages("rio")
library(rio)

# Define the URL of the Excel file on GitHub
file_url <- "https://github.com/AureleData/Data-management-project-in-Rstudio/raw/main/FA%20PI%20DI%20opti%20new%20version.xlsx"

# Read the Excel file directly from the URL
configPIDI <- import(file_url)
# Subset the data
